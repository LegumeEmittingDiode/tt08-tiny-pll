...
C {sky130_fd_pr/nfet3_01v8.sym} -20 30 0 0 {name=MNCAP
W=4
L=2
body=VNB
nf=1
...
C {devices/lab_wire.sym} -80 30 0 1 {name=p2 sig_type=std_logic lab=plus}
C {devices/lab_wire.sym} 0 -60 3 0 {name=p3 sig_type=std_logic lab=minus}
